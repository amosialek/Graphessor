...
void P2(MyGraph& graph, std::vector<vertex_descriptor>& listOfIEdges, std::vector<vertex_descriptor>& listOfFEdges, Image& image);
...
void P5(MyGraph& graph, std::vector<vertex_descriptor>& listOfIEdges, Image& image, double epsilon);
